<template>
    <div class='secDiv'>
      ...
      <!-- 表格 -->
      <el-table :data="tableData" stripe :default-sort = "{prop: 'date', order: 'descending'}" :height="table_height" id="openAccount_table" v-loading="loading">
          <el-table-column type="index" :index="indexMethod" width="90" label="序号"></el-table-column>
          <el-table-column prop="account" label="账号"></el-table-column>          
          <el-table-column prop="nickname" label="昵称"></el-table-column>
          <!-- <el-table-column prop="price" label="支付宝订单号"></el-table-column> -->
